...
int main(void)
{
	...
	LPC_PINCON->PINSEL1 = 0; // for 0.21 switch
	LPC_PINCON->PINSEL3 = 0; // GPIO mode
	// LPC_PINCON -> PINSEL4 = 0;// P2.12 switch

	LPC_GPIO0->FIODIR = 0xFF << 4 | 0 << 21; // output direction P0.4 to P0.11 and input P0.21 switch
